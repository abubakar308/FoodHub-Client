      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
            <header className="mb-8">
              <h1 className="text-2xl font-bold text-foreground">Add New Dish</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-sm font-bold text-foreground/80 flex items-center gap-2">
                  <Utensils size={16} className="text-primary" /> Meal Title
                </label>
                <Input
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    className="rounded-xl border-border py-6 focus-visible:ring-primary"
                    value={price}
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full border border-border bg-background rounded-xl px-3 py-[14px] text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-foreground"
                    required
                  >
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="block w-full rounded-xl border border-border bg-background px-4 py-3 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                  required
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4">
                <Button 
                  type="submit" 
                  disabled={loading}
                  className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl px-8 py-6 font-bold shadow-lg shadow-green-100 dark:shadow-none transition-all"
                >
                  {loading ? (
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 space-y-4">
            <h2 className="text-sm font-bold text-muted-foreground uppercase tracking-wider">Live Preview</h2>
            <div className="rounded-[24px] border border-border bg-card overflow-hidden shadow-sm">
              ...
              <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <p className="text-primary font-bold">৳{price || "0"}</p>
                </div>
