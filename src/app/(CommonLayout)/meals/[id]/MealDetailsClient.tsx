        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4">
            <div className="flex items-end gap-3">
              ...
              {hasDiscount && (
                <span className="text-lg font-semibold text-muted-foreground line-through mb-1">
                  ৳{meal.price}
                </span>
              )}
            </div>
            <Button
               ...
               disabled={adding || meal.isAvailable === false}
               size="lg"
               className="rounded-full font-bold px-8 h-12 gap-2 text-md shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all"
            >
              {adding ? <Loader2 className="animate-spin h-5 w-5" /> : <ShoppingCart className="h-5 w-5" />}
              <span>{meal.isAvailable === false ? "Unavailable" : "Add to Cart"}</span>
            </Button>
          </div>
...
// Not-found placeholder used by page.tsx
